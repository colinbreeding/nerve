          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="relative">
              ...
              <input
                ...
                } w-full rounded-lg mt-4 py-2 px-4 bg-neutral-200 dark:-bg-darkGrey text-[16px] -text-smoothBlack dark:text-white placeholder-neutral-500 dark:placeholder-neutral-400`}
                {...register("name")}
              />
              {errors.name && (
            ...
            <button
              type="submit"
              className="w-full text-[16px] h-[40px] mt-2 py-2 -bg-steelBlue hover:-bg-pictonBlue rounded-full text-white transition duration-150 ease-in-out"
            >
              {isLoading ? (
