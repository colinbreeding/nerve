...
export const Comment: React.FC<CommentType> = (comment) => {
  ...
  return (
    <div className="w-full h-fit my-1 md:my-4 p-4 bg-white dark:-bg-grey/50 md:rounded-lg md:border border-neutral-200 dark:-border-darkGrey shadow-lg cursor-pointer">
